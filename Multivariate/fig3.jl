...
results = load_object("../results/mv_mcmc.jld2")
inits, ck_not_update, w_all, c_all, r_all, 
g_result, β_all, ϕ_all, Σ_all, ind_all = results
...
savefig("../results/fig3a.png", transparent=true, dpi=300, bbox_inches=bbox, pad_inches=0)
...
savefig("../results/fig3b.png", transparent=true, dpi=300, bbox_inches=bbox, pad_inches=0)
...
savefig("../results/fig3c.png", transparent=true, dpi=300, bbox_inches=bbox, pad_inches=0)


img1 = imread("../results/fig3a.png")
img2 = imread("../results/fig3b.png")
img3 = imread("../results/fig3c.png")
...
fig.patch.set_alpha(0.0)
savefig("../results/fig3.pdf", dpi=300, transparent=true, pad_inches=0)